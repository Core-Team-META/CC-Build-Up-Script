...
function Module.Ease(object, property, goal, easeDuration, easingEquation, easingDirection, easingParameter1, easingParameter2)
	...
	wrapTask(property, object, function()
		...
		local x = easingFormula(currentTime, startX, directionX * math.abs(goalX - startX), easeDuration, easingParameter1, easingParameter2)
		local y = easingFormula(currentTime, startY, directionY * math.abs(goalY - startY), easeDuration, easingParameter1, easingParameter2)
		local z = easingFormula(currentTime, startZ, directionZ * math.abs(goalZ - startZ), easeDuration, easingParameter1, easingParameter2)
...
function Module.EasePosition(object, goal, easeDuration, easingEquation, easingDirection, easingParameter1, easingParameter2)
	assert(goal:IsA("Vector3"), "Attempting to ease to a goal that is not a Vector3")

	Module.Ease(object, "Position", goal, easeDuration, easingEquation, easingDirection, easingParameter1, easingParameter2)
end

function Module.EaseWorldPosition(object, goal, easeDuration, easingEquation, easingDirection, easingParameter1, easingParameter2)
	assert(goal:IsA("Vector3"), "Attempting to ease to a goal that is not a Vector3")

	Module.Ease(object, "WorldPosition", goal, easeDuration, easingEquation, easingDirection, easingParameter1, easingParameter2)
end

function Module.EaseRotation(object, goal, easeDuration, easingEquation, easingDirection, easingParameter1, easingParameter2)
	assert(goal:IsA("Rotation"), "Attempting to ease to a goal that is not a Rotation")

	Module.Ease(object, "Rotation", goal, easeDuration, easingEquation, easingDirection, easingParameter1, easingParameter2)
end

function Module.EaseWorldRotation(object, goal, easeDuration, easingEquation, easingDirection, easingParameter1, easingParameter2)
	assert(goal:IsA("Rotation"), "Attempting to ease to a goal that is not a Rotation")

	Module.Ease(object, "WorldRotation", goal, easeDuration, easingEquation, easingDirection, easingParameter1, easingParameter2)
end

function Module.EaseScale(object, goal, easeDuration, easingEquation, easingDirection, easingParameter1, easingParameter2)
	assert(goal:IsA("Vector3"), "Attempting to ease to a goal that is not a Vector3")

	Module.Ease(object, "Scale", goal, easeDuration, easingEquation, easingDirection, easingParameter1, easingParameter2)
end

function Module.EaseWorldScale(object, goal, easeDuration, easingEquation, easingDirection, easingParameter1, easingParameter2)
	assert(goal:IsA("Vector3"), "Attempting to ease to a goal that is not a Vector3")

	Module.Ease(object, "WorldScale", goal, easeDuration, easingEquation, easingDirection, easingParameter1, easingParameter2)
end
